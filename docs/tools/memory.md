...
The tool appends the provided `fact` to your context file in the user's home directory (`~/.qwen/SPEC.md` by default). This filename can be configured via `contextFileName`.
